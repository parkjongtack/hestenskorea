<table width="907" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>
	<div class="D11_99" style="padding:14 0 5 0;">
		<!--<a href="http://www.hastens.com/en/" target="_blank">Head H&#228;stens</a>
		<img src="/img/inc/line.gif">
		<a href="../../center/map.php">Contact</a>
		<img src="/img/inc/line.gif">
		<a href="http://www.hastens.com/en/Ovriga-Sidor/Footerlinks/ABOUT-HASTENS/Activate-warranty/" target="_blank">Activate warranty</a>
		<img src="/img/inc/line.gif">
		<a href="../../center/dvd.php">Order DVD</a>
		<img src="/img/inc/line.gif">

    <? if (!$member['mb_id']) { ?>  -->
<!-- 로그인 이전--> 
   <!-- <a href="../../bbs/login.php?url=<?=$urlencode?>">Admin</a>  -->
    <? } else { ?> 
<!--로그인 이후--> 
    <a href="../../bbs/logout.php">Logout</a> 
    <? } ?>
	</div>	
	<div class="D11_55" style="padding:0 0 35 0;">Copyrightⓒ2011 H&#228;stens. All rights reserved.</div></td>
    <td width="290">
	<div style="padding:14 0 40 0;"><span class="D11_99" style="padding-right:4;">H&#228;stens Worldwide</span> 
