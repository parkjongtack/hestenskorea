...
<!--
<div id="popuplayer-1" style="border:1px solid #000000;display:none;position:absolute;top:10px;left:10px;z-index:999;">
    <div>
		<a href="http://www.hastenskorea.com/bbs/board.php?bo_table=notice&wr_id=91&page=0&sca=&sfl=&stx=&sst=&sod=&spt=0&page=0" target="_blank"><img src="/popup/image/popup_171226.jpg" /></a>
	</div>
    <form name="frm1">
    <table style="width:700px; background-color:#222222;">
...
<!--div id="popuplayer-2" style="border:1px solid #000000;display:none;position:absolute;top:0px;left:405px;z-index:999;">
    <div>
		<img src="/img/pop/20170504_start.jpg" />
	</div>
    <form name="frm2">
    <table style="width:400px; background-color:#222222;">
      <tr style="background-color:#222222;">
	    <td style="width:4%; line-height:20px; padding: 4px 0px 0px 2px;"> <input type="Checkbox" name="checkpop" value="" onclick="set_popup2();"></td>
	    <td style="width:84; color:#ffffff; font-size:10pt; padding:4px 0 0 0;">오늘 하루 이 창을 열지 않음.</td>
	    <td style="width:12%;"><a href="javascript:set_close2();"><span style="color:#ffffff; font-size:10pt;">닫기&nbsp;&nbsp;</span></a></td>
      </tr>
    </table>
    </form>
</div-->
...
<table>
<tr>
<td style="padding-top:90px"><a href="http://www.hastenskorea.com/bbs/board.php?bo_table=notice&wr_id=94&page=0&sc
a=&sfl=&stx=&sst=&sod=&spt=0&page=0" target="_blank"><img src="img/re_ready.jpg" width="907" height="491" usemap="#Map"></a>
	<!--<map name="Map">
  <area shape="rect" coords="31,34,404,180" href="http://www.hastenskorea.com/bbs/board.php?bo_table=notice&wr_id=91">
</map>-->
</td>
</tr>
</table>
