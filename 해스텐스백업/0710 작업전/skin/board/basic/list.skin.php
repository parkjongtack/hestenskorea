...
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr>
        ...
        <th background='<?=$board_skin_path?>/img/title_bg2.gif' style="padding:0px 0 4 0px;"><font color=ffffff>제목</font></th>

        <th class="datetime" background='<?=$board_skin_path?>/img/title_bg2.gif' style="padding:0px 0 4 0px;"><?=subject_sort_link('wr_datetime', $qstr2, 1)?><font color=ffffff>작성일</font></a></th>
    ...
    <tr class="bg<?=$bg?>"> 
        ...
        <td class="subject">
            ...
            if ($list[$i][is_notice])
                echo "<a href='{$list[$i][href]}'><span class='D12_43'>{$list[$i][subject]}</span></a>";
            else
                echo "<a href='{$list[$i][href]}'><span class='D12_43'>{$list[$i][subject]}</span></a>";
