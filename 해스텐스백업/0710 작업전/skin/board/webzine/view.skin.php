...
<div style="border:0px solid #ddd; clear:both; height:25px; background:url(<?=$board_skin_path?>/img/title_bg3.gif) repeat-x;">
    ...
    <tr>
        <td style="padding:4px 0 0 20px;" class="D12B_FF">
            <div style="color:#505050; font-size:13px; font-weight:bold; word-break:break-all;">
            <? if ($is_category) { echo ($category_name ? "[$view[ca_name]] " : ""); } ?>
            <font color=ffffff><span class="D12B_FF"><?=cut_hangul_last(get_text($view[wr_subject]))?></span></font>
            </div>
        </td>
...
<tr>
    <td height=28 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#888;">
...
<tr> 
    <td height="150" style="word-break:break-all; padding:20px;">
        ...
        <!-- 내용 출력 -->
        <span id="writeContents" style="word-break:break-all;line-height:184%;letter-spacing:-0.02em;"><?=$view[content];?></span>
...
<div style="both; height:60px;">
    ...
    <div style="padding: 5 0 5 20; " class="left">▲ 다음글 : </div><div style="padding: 5 0 5 20; "><? if ($prev_href) { echo "<a href=\"$prev_href\" title=\"$prev_wr_subject\">$prev_wr_subject</a>&nbsp;"; } ?></div>
    <div class="both" id="boardline" ><hr></div>
    <div style="padding: 5 0 5 20; " class="left">▼ 이전글 : </div><div style="padding: 5 0 5 20; "><? if ($next_href) { echo "<a href=\"$next_href\" title=\"$next_wr_subject\">$next_wr_subject</a>&nbsp;"; } ?></div>
    </div>
