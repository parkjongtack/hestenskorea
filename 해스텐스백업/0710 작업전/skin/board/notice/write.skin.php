...
<div style="border:0px solid #ddd; height:34px; background:url(<?=$board_skin_path?>/img/title_bg3.gif) repeat-x;">
<div style="font-weight:bold; font-size:12px; margin:7px 0 0 10px;"><font color=ffffff>:: 글쓰기 ::</font></div>
</div>
