...
var CloseDate = new Date("September 16, 2013");//날짜제어부분 해당날이 지나면 팝업이 뜨지 않음 
//아래 날짜제어를 쉽게 조정하기위해 첨가한 부분인 소스와는 상관없음
...
if (Today < CloseDate)
{
 var blnCookie = getCookie("popup130830");

 if ( !blnCookie ) {
  win = window.open('/popup/popup130830.php','popup130830','scrollbars=no,width=500,height=682,resizable=no,status=no,left=0,top=0');  
  win.focus();
...
<!--/div-->
<div>
<a href="http://hastenskorea.com/bbs/board.php?bo_table=notice&wr_id=38"> <img src="img/main0905.jpg" width="895" height="555"> </a>
