...
<table width="700" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<tr>
			...
			<td><input class="box" type='text' name='법인등록번호' style="width:134;" required itemname="법인등록번호"> " - " 포함하여 적어주세요</td>
		</tr>
		<tr>
			<td colspan="2" height="1" bgcolor="#DBD8D2"></td>
		</tr>
		...
		<tr>
			<td style='font:bold;color:#666666' height="32">· 상표 또는<br><font color="#FFFFFF">·</font> 서비스표</td>
			<td><input class="box" type='text' name='상표또는서비스표' style="width:100%;" required itemname="상표또는서비스표"></td>
		</tr>
		<tr>
			<td colspan="2" height="1" bgcolor="#DBD8D2"></td>
		</tr>
		<tr>
			<td style='font:bold;color:#666666' height="32">· 사용할 상품<br><font color="#FFFFFF">·</font> 또는 서비스업</td>
			<td><TEXTAREA NAME="사용할상품또는서비스업" ROWS="5" class="box" style="width:99%;" required itemname="사용할상품또는서비스업"></TEXTAREA></td>
		</tr>
		<tr>
	...
	<tr>
		<td><img src="/images/103.gif"></td>
	</tr>
	<tr>
		<td>
		(1) 출원인 및 발명자의 한글과 영문 성명, 주민등록번호, 주소, 연락전화번호<br>
		(2) 사업자 등록증(법인명의 출원시)<br>
		(3) 사용인감증명(법인명의 출원시 출원인코드신청서 및 위임장에 날인)<br>
		(3) 소득세원천징수이행상황신고서(소기업, 중소기업으로서 출원료 감면대상인 경우)<br>
		(4) 발명(고안)의 간단한 설명서와 도면(특허, 실용신안출원의 경우)<br>
		(5) 출원하고자 하는 물품의 견본 또는 사진(디자인출원의 경우)<br>
		</td>
	</tr>
	<tr>
		<td height="20"></td>
