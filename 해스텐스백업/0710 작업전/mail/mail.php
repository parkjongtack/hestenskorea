...
<table width="640" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<tr>
			<td height="32" class="D12_43">이름</td>
		...
		<tr>
			<td height="32" class="D12_43">E-mail</td>
			<td><input class="input_search" type='text' name='email' style="width:155;" email required itemname="이메일"></td>
		</tr>
		<tr>
			<td colspan="2" height="1" bgcolor="#c9d0e5"></td>
		</tr>
		...
		<tr>
			<td height="32" class="D12_43">내용</td>
			<td><TEXTAREA NAME="내용" ROWS="15" class="input_search" style="width:99%;" itemname="내용"></TEXTAREA></td>
		</tr>
			<tr>
			<td colspan="2" height="1" bgcolor="#c9d0e5"></td>
		</tr>
