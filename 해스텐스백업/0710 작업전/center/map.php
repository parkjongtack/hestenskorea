...
<!--       <div><img src="/img/cen/left011_on.gif"></div-->
      <div style="padding-top:2"><a href="map.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('map','','/img/cen/left011_on.gif',1)"><img src="/img/cen/left011.gif" name="map"></a></div>
       <div style="padding-top:2"><a href="http://www.hastenskorea.com/bbs/board.php?bo_table=notice" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('news','','/img/cen/left012_on.gif',1)"><img src="/img/cen/left012.gif" name="news"></a></div>
...
<!--       <div style="padding-top:2"><a href="contact.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('left04','','/img/cen/left04_on.gif',1)"><img src="/img/cen/left04.gif" name="left04"></a></div>
	...
	<div class="both" style="padding:25 0 0 34"><div class="D11_66"> HOME > 해스텐스 서울 > 오시는 길 > 해스텐스 청담플래그십 스토어
</div></div>
	<div class="both" style="padding:6 0 0 34"><img src="/img/cen/tt_map.gif"></div>
	<!--<div class="both" style="padding:14 14 0 0;text-align:right;"><a href="map.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('tab_map01','','/img/cen/tab_map01_on.gif',1)"><img src="/img/cen/tab_map01_on.gif" name="tab_map01" border="0" style="margin-right:3;"></a><!--<a href="map2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('tab_map02','','/img/cen/tab_map02_on.gif',1)"><img src="/img/cen/tab_map02.gif" name="tab_map02" border="0"style="margin-right:3;"></a></div> -->
	<div class="both" id="greyline" style="width:720;"><hr></div>
	<!-- 게시판테이블 -->
<!--	<div class="both" style="padding:10 0 0 54"><img src="/img/cen/map.gif" border="0"></div>-->
	<div class="both" style="padding:10 0 0 54"><img src="/img/cen/map.jpg" border="0"></div>
	<div class="both" style="height:100;"></div>
<!--추가-->
	<a name="#Map2">
	<div class="both" style="padding:6 0 0 34"><img src="/img/cen/tt_map2.jpg"></div>
	</a>
	<div class="both" id="greyline" style="width:720;"><hr></div>
	<div class="both" style="padding:10 0 0 54"><img src="/img/cen/map2.jpg" border="0"></div>
<!--추가-->
	<div class="both" style="height:100;"></div>
	<!-- //게시판테이블 -->
	</td>
...
<!-- //따라다니는 스크롤바 -->
<map name="Map">
  <area shape="rect" coords="109,44,294,61" href="mailto:info@hastensseoul.com ">
</map>
</body>
</html>
