...
#gnb {position:relative; height:5px; }
...
#gnb li a.sub-title5 {float:left; padding:0px 10px 2px 698px; color:#ffffff;}
#gnb li.current {}
...
<div id="contents">
<!-- top메뉴 -->
<object width="907" height="50">
<div class="both"  width="990" height="50" border="0" >
...
<!--			<li><a class="sub-title" href="/handmade/history.php">해스텐스 역사</a></li>-->
	...
	<li class="menu menu3"><a class="menu-title" href="/handmade/craftmanship.php">해스텐스제품의 특징</a>
		<ul class="layer layer3">
			<li class="first-child"><a class="sub-title3" href="/natural/horsehair.php">천연소재</a></li>
