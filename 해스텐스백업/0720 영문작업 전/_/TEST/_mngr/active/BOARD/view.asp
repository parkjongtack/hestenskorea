...
<div id="custom-content" class="white-popup-block" style="<%if levelChk="N" then%>display:none;<%end if%>max-width:778px; margin-top:20px; z-index:10000000000000000000000; background:#fff; margin: 50px auto;">
  ...
  <script>
    ...
    $("#writeDiv").attr("src","/_mngr/active/BOARD/write.asp?m_idx="+str);
		$('#xButton').click();
  }
	...
	<center>  
                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <td bgcolor='#cccccc' height='1'></td>
												...
												<tr align="center"   >
                          <td  align="left"   bgcolor='#FFFFFF' style='padding:10px 0px;'>
													<img src="/upload/board/<%=file_sv%>" style='max-width:<%=fw%>px;max-height:<%=fh%>px;'>					
													</td>
												</tr>
												<tr align="center"   >
                          <td bgcolor='#cccccc' height='1'></td>
												...
												<%
												if not isEmptyStr(link_txt) then
												    if boardCate="MEDIA" then
												%>
												<tr align="center"   >
                          <td  align="left"   bgcolor='#FFFFFF' style='padding:10px 0px;'>
													<a href="<%=link_txt%>" target="_blank"><%=link_txt%></a>
													</td>
												</tr>
												<%
												    elseif boardCate="VIDEO" then
														    link_txt = "https://www.youtube.com/embed/"&link_txt&"?enablejsapi=1&amp;rel=0"
														
												%>
												<tr align="center"   >
                          <td  align="left"   bgcolor='#FFFFFF' style='padding:10px 0px;'>
													<iframe id="movie_iframe_0" allowfullscreen="" frameborder="0" height="315"  src="<%=link_txt%>" width="596" height="350"></iframe>
													</td>
												</tr>
                          ...
                          <td bgcolor='#cccccc' height='1'></td>
												...
												<tr  align="center" >	
												  <td  align="left"   bgcolor='#FFFFFF' style='padding:10px 0px;'>
													<%if boardCate="MEDIA" then%>보도 날짜<%else%>작성일<%end if%> : <%=view_date%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  언어 : <%=b_langCheck%>
                          ...
                          <td bgcolor='#cccccc' height='1'></td>
												...
												<%if not isEmptyStr(content) then%>
												<tr align="center"  >
