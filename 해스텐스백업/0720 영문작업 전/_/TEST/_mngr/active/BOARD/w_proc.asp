    ...
    Call connClose()	
     ...
     Call connOpenOnly()
        With conn     
            ...
            .ActiveConnection = dbCon
            .CommandText = "update TB_board set boardCate=?,title=?,content=?,view_date=?,file_or=?,file_sv=?,link_txt=?,b_langCheck=?,b_modiIp=?,file_or_list=?,file_sv_list=?, b_modiDate=getDate() where idx=?"
            .CommandType = adCmdText
