...
Dim boardCate : boardCate="LETTER"
%>
<script src="/common/js/jquery-2.1.3.min.js"></script>
<!-- #include virtual="/common/inc/modal.asp" -->
<div id="contentDiv" >
<!-- #include file="active/LL/exe_inc_config.asp" -->
<!-- #include file="active/LL/exe_inc_subMenu.asp"; -->
<!-- #include file="active/LL/exe_inc_searchForm.asp"; -->
<!-- #include file="active/LL/exe_inc_list.asp"; -->
</div>
