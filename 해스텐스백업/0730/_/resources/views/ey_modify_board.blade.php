        ...
        <div class="write_box">
            ...
            <div class="write_line">
                <div class="all_line">
						...
						<div class="line_content">
							<div id="editor">
								<div id="edit" style="width:900px;">{!! $data5->contents !!}</div>
							</div>
                ...
                <div class="write_line cate_file slider_area">
					...
					<div class="all_line">
						...
						<div class="line_content">
							...
							<div>
								소제목 : <input type="text" value="{{ $data2->sub_subject }}" style="border:none" readonly />
								소제목2 : <input type="text" value="{{ $data2->sub_subject2 }}" style="border:none" readonly />
								소제목3 : <input type="text" value="{{ $data2->sub_subject3 }}" style="border:none" readonly />
								우선순위 : {{ $data2->priority }}
