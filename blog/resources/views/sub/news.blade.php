@include('inc/head')
			<div id="sub_sec">
                <div class="news">
                    <div class="news_tabs">
                        <a href="/sub/press?tab=3" class="tans03 hei85p @if($_SERVER['REQUEST_URI'] == '/sub/press?tab=3') on @endif">공지사항</a><a href="/sub/press?tab=1" class="tans01 hei85p @if($_SERVER['REQUEST_URI'] == '/sub/press?tab=1') on @endif">PRESS</a><a href="/sub/media?tab=2" class="tans02 hei85p @if($_SERVER['REQUEST_URI'] == '/sub/media?tab=2') on @endif">MEDIA</a>
                    </div>
